      ...
      <div class="widget-box span6">
        ...
        <div class="widget-content" >
          <form action="" method="post" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data">
            ...
            <div class="control-group">
              <label class="control-label">Foto Masakan :</label>
              <div class="control-group">
                <div class="controls">
          ...
          <?php
            if(isset($_POST['tambah_menu'])){
              ...
              //echo "<br></br>";
              $query_tambah_masakan = "INSERT INTO tb_masakan VALUES (null,'$nama_masakan','$harga','$stok','$status_masakan','$gambar')";
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Restaurant <a href="#">by Yoga Esabio</a> </div>
</div>
