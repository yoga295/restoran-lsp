...
<body>
	<div class="limiter">
		<div class="container-login100" style="background-image: url('template/masuk/images/3394.jpg');">
			<div class="wrap-login100 p-t-120 p-b-30">
				<form action="" method="post" class="login100-form validate-form">
					...
					?>
						<div class='container'>	
							<div class = 'alert alert-danger'>
								<span>
									<center>Username atau Password Anda Salah</center>
								</span>
							</div> 
						</div>
					<?php 
					...
					<div class="login100-form-avatar">
						<img src="template/masuk/images/restaurant.png" alt="AVATAR">
					</div>
